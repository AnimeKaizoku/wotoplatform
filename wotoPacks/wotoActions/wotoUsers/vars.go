...
var (
	_batchHandlers = map[wa.BatchExecution]wv.ReqHandler{
		...
		BATCH_GET_USER_LIKED_LIST:         batchGetUserLikedList,
		BATCH_GET_USER_LIKED_LIST_COUNT:   batchGetUserLikedListCount,
		BATCH_APPEND_USER_LIKED_LIST:      batchAppendUserLikedList,
		BATCH_DELETE_USER_LIKED_LIST_ITEM: batchDeleteUserLikedListItem,
	}
)
