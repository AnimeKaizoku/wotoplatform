...
type RequestEntry struct {
	...
	// Data is the spcific data that client sends alongside of
	...
	// server; use this field to comminucate with the client.
	...
	// specific handler in the spcific package; that handler
	// can block its connection's goroutine as much as it wants
	// and it can communicate with the client there.
	// when it wants to end its comminucation (like if battle is over),
